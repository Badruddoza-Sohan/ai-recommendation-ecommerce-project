...
const signupSchema = z.object({
  ...
  businessType: z.enum(["Individual Seller", "Small Business", "Retail Store", "Wholesaler", "Manufacturer"]).optional(),
  ...
  if (input.accountType !== "seller") return;
  const requiredFields: Array<[keyof typeof input, string]> = [
