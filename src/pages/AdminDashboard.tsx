...
export default function AdminDashboard() {
  ...
  const handleOrderStatusChange = async (orderId: number, status: "pending" | "processing" | "shipped" | "delivered" | "cancelled" | "refunded") => {
    try {
  ...
  return (
    <div className="dashboard-shell flex min-h-screen min-w-0 bg-[#F4F6FC] dark:bg-slate-950/50">
      ...
      <aside className={`fixed inset-y-0 left-0 z-50 w-64 shrink-0 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 transform transition-transform duration-300 ease-in-out flex flex-col lg:static lg:min-h-screen lg:translate-x-0 ${
        ...
        <div className="border-b border-slate-200 p-4 dark:border-slate-800">
          ...
          <div className="mt-3 flex items-center justify-between">
            <h2 className="text-lg font-bold text-[#5B6DF8] dark:text-indigo-400">Admin Panel</h2>
