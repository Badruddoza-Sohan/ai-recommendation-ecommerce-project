                      ...
                      {(() => {
                         try {
                           ...
                           return (
                             <>
                               {attr.color && (
                                 <span className="flex items-center gap-1.5 text-xs text-slate-500 font-medium bg-slate-100 dark:bg-slate-700/50 px-2 py-1 rounded">
                                   <div className="w-3 h-3 rounded-full border border-slate-300" style={{ backgroundColor: attr.color }} />
                                   {attr.color}
                                 </span>
                               )}
                               {attr.size && (
                                 <span className="text-xs text-slate-500 font-medium bg-slate-100 dark:bg-slate-700/50 px-2 py-1 rounded">
                                   Size: {attr.size}
                                 </span>
                               )}
                             </>
        ...
        <div className="lg:col-span-1 animate-slide-left">
          <div className="glass-card rounded-2xl p-6 sm:p-8 sticky top-24">
            ...
            <div className="mt-6 flex items-center justify-center gap-2 text-xs font-medium text-slate-500 bg-slate-50 dark:bg-slate-800/50 py-2.5 rounded-lg border border-slate-100 dark:border-slate-700">
              ...
              Free shipping on orders over BDT 500
            </div>
          </div>
        </div>
      </div>
